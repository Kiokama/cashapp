    ...
    <div className="login-page">
      ...
      <div className="login-container animate-scaleIn">
        ...
        <div className="login-logo">
          ...
          <p className="logo-subtitle">Quản lý chi tiêu thông minh cho cặp đôi</p>
        </div>
        ...
        <p className="login-footer">
          Chưa có tài khoản? <button className="link-btn" onClick={handleSubmit}>Đăng ký miễn phí</button>
        </p>
      </div>
    </div>
  );
